...
FIGS = [
    ...
    dict(fid="fig-w7-reliability", page=AG, loc=r'The Reliability Mathematics', mode="after_p",
         ...
         svg=D.linechart([
             dict(label="end-to-end reliability", color="#9a2f2f",
                  pts=[(0.05, 0.90), (0.10, 0.81), (0.25, 0.59), (0.50, 0.35), (0.75, 0.21), (1.0, 0.12)], above=True),
         ], [(0.05, "1 step"), (0.5, "10 steps"), (1.0, "20 steps")],
            "Reliability decays as pipelines get longer",
            "A declining curve of end-to-end reliability against the number of agent steps.",
            ylabel="reliability", note="At 90% reliability per step, a 20-step pipeline finishes correctly about 12% of the time.")),
