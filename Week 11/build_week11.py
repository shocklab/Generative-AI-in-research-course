...
SL1_BODY = """
  ...
  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">Four lines of work, all peer-reviewed, all with humans verifying outputs in a laboratory, give the clearest <em>publishable</em> picture of what AI is currently contributing to active scientific research. They are not the whole picture &mdash; we return below to a second, more diffuse, and arguably larger category of AI-as-collaborator that does not yet fit inside a single headline paper &mdash; but they are the cleanest places to anchor a discussion of what is actually working.</p>
  ...
  <div class="technical-detail">
    ...
    <p style="color: #444; line-height: 1.75; margin-bottom: 12px;">The four examples above are the clearest <em>publishable</em> demonstrations of what AI now contributes to research. They share a property that makes them legible: each one fits inside a single paper, with a single primary result. But there is a second category of &ldquo;AI as collaborator&rdquo; that is harder to point at in headline form and arguably bigger in aggregate effect.</p>
    <p style="color: #444; line-height: 1.75; margin-bottom: 12px;">Agentic coding tools &mdash; <em>Claude Code</em>, <em>Codex</em>, <em>Cursor</em>&#39;s agent modes &mdash; have moved over the last twelve months from completing one line of code at a time to running for hours on complex, multi-step research tasks. Used by individual researchers with strong domain judgement and the verification habits covered in Weeks 9 and 10, these tools now meaningfully support experimental code drafting, multi-stage data analysis, theoretical reasoning, debugging across substantial codebases, and large parts of manuscript construction &mdash; not just the literature search and code completion the early framing of &ldquo;AI as narrow-task assistant&rdquo; suggested. Practitioners report that genuinely intellectually demanding work which previously took months can sometimes be compressed into days or weeks. The active researcher community has begun to describe agentic coding tools as the single most consequential change AI has made to their day-to-day research practice.</p>
    <p style="color: #444; line-height: 1.75; margin-bottom: 12px;">The reason this category is harder to evaluate than the four lab-scale examples is that the productivity depends substantially on the researcher: their existing domain skill, their willingness to verify outputs at every meaningful junction, and their judgement about which parts of the work they will and will not delegate. Two researchers using identical tools can have wildly different experiences. The bottleneck for many active researchers is no longer the tool&#39;s capability but their own practice around it. For students reading this from the start of their research careers, getting the practice right is now a first-order skill.</p>
  ...
  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">If you are starting a research project in 2026, you are scoping work that you will be defending at a viva in 2027 or 2028, and publishing from for some years after. The honest framing is that most of what this sub-lesson describes is happening <em>now</em>, or will land inside the next twelve months. Five years out is a different category &mdash; genuinely unknowable, and things could be radically different by 2030 in either direction. The relevant horizon for present decisions is the one immediately in front of you, not a hedge across half a decade. Three honest implications follow from that picture.</p>

  <ul class="styled-list">
    <li><strong>AI as a substantive research collaborator is here, not just AI as a narrow-task assistant.</strong> The picture set out in the four cards above plus the workflow-level shift discussed in the &ldquo;Beyond the headline papers&rdquo; box means that, for researchers prepared to use the tools well, AI is now genuinely participating across literature, ideation, code, analysis, theoretical reasoning, and manuscript construction &mdash; not only at particular stages. Practitioner reports (Mineault, Mollick) and the early findings of the Anthropic social-sciences study point the same way. The Week 5&ndash;10 tools are worth integrating across your workflow, not just at the edges. The decision is not <em>whether</em> to use them but <em>where</em> verification has to happen, and that decision is per task, not per tool.</li>
...
SL_SUPP_BODY = """
  <div class="intro-text">
    <h2>&#127919; What We&#39;ll Cover</h2>
    <p>Sub-Lesson 11.1 deliberately stayed inside the present and the very near term &mdash; results that are already shipping or that look highly likely to land within the next year, and that you can therefore actually check against primary sources today. This sub-lesson takes the same calibrated reading habit and applies it to the genuinely <em>speculative</em> end of the AI-in-research literature &mdash; the work that asks not &ldquo;what does AI do for science now?&rdquo; but &ldquo;what could AI do for science, eventually, and what would that change?&rdquo; Five years out is unknowable territory; the framework of 11.1 stops well short of it deliberately.</p>
...
SL4_BODY = """
  ...
  <ul class="styled-list">
    ...
    <li><strong>Watch the continental-compute landscape, but plan around what you can use now.</strong> Several African higher-education-led compute initiatives are at various stages of standing-up &mdash; some institution-specific, some pan-continental &mdash; but as of May 2026 none of them are broadly available at the individual-researcher tier. The honest default for the next 12&ndash;18 months is the combination of DataSpires (Africa-located, individual-tier) plus the existing free-tier cloud options below, with CHPC as the South-Africa-specific fallback for academic use.</li>
...
SL5_BODY = """
  ...
  <p style="color: #555; line-height: 1.75; margin-top: 20px; margin-bottom: 15px;"><strong>Coming up in 11.6:</strong> we turn from data and models to the remaining two layers of the stack &mdash; policy and talent. The African Union Continental AI Strategy in its operational detail, the national strategies of South Africa / Kenya / Rwanda / Nigeria / Egypt (and the peer-reviewed comparative analysis in Yilma &amp; Wodajo&#39;s <em>Science and Public Policy</em> special section), and the institutional landscape of Deep Learning Indaba, AIMS, ARIN, and Lelapa as the talent pipeline. We close 11.6 with the question that opens Week 12 (the integrative capstone): given everything we now know about African AI capacity, what is the most useful thing a postgraduate in this room can actually do?</p>
"""
...
SL6_BODY = """
  ...
  <div class="card-grid">
    ...
    <div class="card">
      ...
      <p>The funded research network behind <strong>IDRC AI4D Africa</strong> (and now its global phase 2, <em>Responsible AI, Empowering People</em>, with FCDO and continued Sida participation) supports <strong>13 multidisciplinary AI labs &mdash; research labs and innovation labs combined &mdash; across the continent</strong>, plus a parallel set of thematic innovation hubs and policy hubs. The 13 labs as of mid-2026:</p>
      <ul class="styled-list" style="margin-top: 0;">
        <li><strong>AfriAI Lab</strong> &mdash; the Anglophone-Africa lab, jointly hosted by the University of Dodoma (UDOM) and the Nelson Mandela African Institute of Science and Technology (NM-AIST), <em>Tanzania</em>.</li>
        <li><strong>CITADEL 2.0</strong> (Centre of Interdisciplinary Excellence in AI for Development) &mdash; the Francophone-Africa lab; collaboration between Burkina Faso Virtual University and Open Burkina, <em>Burkina Faso</em>.</li>
        <li><strong>Responsible AI Lab II (RAIL)</strong> &mdash; at Kwame Nkrumah University of Science and Technology (KNUST), <em>Ghana</em>.</li>
        <li><strong>RobotsMali AI4D Lab</strong>, <em>Mali</em>.</li>
        <li><strong>Resonance Lab</strong> at Addis Ababa University, <em>Ethiopia</em>.</li>
        <li><strong>Data Innovation Centre for AI</strong>, <em>Senegal</em>.</li>
        <li><strong>AI Living Lab for Innovative and Viable Ethical Policies (ALIVE Lab)</strong>, <em>Senegal</em>.</li>
        <li><strong>AI4D African Languages Lab</strong>, <em>South Africa</em>.</li>
        <li><strong>African Hub on AI Safety, Peace and Security</strong> &mdash; anchored at UCT, co-led with the Global Center on AI Governance; the only lab in the network dedicated to policy and governance, <em>South Africa</em>.</li>
        <li><strong>AI for Sustainable Development Goals (AI4SDG) Lab</strong>, <em>Nigeria</em>.</li>
        <li><strong>Centre for Data Science and AI</strong> at Dedan Kimathi University, <em>Kenya</em>.</li>
        <li><strong>TAIRI Lab</strong> at the University of Rwanda &mdash; focused on agriculture, health, and the environment, <em>Rwanda</em>.</li>
        <li><strong>Makerere University AI for Development Research Lab</strong>, <em>Uganda</em>.</li>
      </ul>
      <p style="margin-top: 12px;">Around this lab network sits a parallel layer of thematic <strong>innovation hubs</strong> &mdash; the most active continental ones include AI for Climate Action (WASCAL Ghana with RUFORUM Uganda and AKADEMIYA2063); AI for Agriculture and Food Systems (ATPS Nigeria with ICIPE and Kumasi Hive); AI for Education (University of Lagos with Universit&eacute; d&#39;Abomey Calavi in Benin and Data Science Nigeria); the Hub on AI for Sexual, Reproductive and Maternal Health (Makerere Infectious Disease Institute with Sunbird AI); and Gender and Responsible AI (IPAR Senegal, SunbirdAI Uganda, CSEA Nigeria) &mdash; plus policy hubs including the Global Index on Responsible AI and the African Observatory on Responsible AI (both <em>South Africa</em>), the East African AI Policy Centre at Strathmore / CIPIT (<em>Kenya</em>), and Advancing Responsible AI in African Union Member States (<em>Ethiopia</em>). Ecosystem-support partners include Villgro Africa (entrepreneur grants) and a joint Data Science Africa &times; Deep Learning Indaba early-career research awards programme.</p>
      <p>Why this matters here: when 11.4 referred to &ldquo;AI4D-affiliated labs&rdquo;, the 13 labs above are the network. It is also the cleanest example in the institutional landscape of how Northern public funding (IDRC, Sida, FCDO) flows into specific named African research infrastructure rather than into individual researchers, and a useful counterpoint to the brain-drain framing below &mdash; the network is explicitly designed to keep talent on the continent inside funded institutional homes.</p>
      <p style="color: #888; font-size: 0.9em;"><a href="https://ai4d.ai" target="_blank" rel="noopener">ai4d.ai</a> &middot; <a href="https://www.ai4d.ai/projects" target="_blank" rel="noopener">ai4d.ai/projects</a> &middot; <a href="https://idrc-crdi.ca/en/initiative/artificial-intelligence-development" target="_blank" rel="noopener">IDRC AI4D page</a></p>
    </div>
  </div>
