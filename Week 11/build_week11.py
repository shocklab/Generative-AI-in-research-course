...
SL6_BODY = """
  ...
  <div class="card-grid">
    ...
    <div class="card">
      <h3>The AI4D Africa lab and network ecosystem</h3>
      <p>The funded research network behind <strong>IDRC AI4D Africa</strong> (and now its global phase 2, <em>Responsible AI, Empowering People</em>, with FCDO and continued Sida participation) is a substantial chunk of the African AI institutional landscape. It runs on two organisational tracks.</p>
      <p><strong>Multidisciplinary university labs.</strong> The Anglophone lab is a joint project of the <strong>University of Dodoma (UDOM)</strong> and the <strong>Nelson Mandela African Institute of Science and Technology (NM-AIST)</strong> in Tanzania; the Francophone lab is <strong>CITADEL</strong> in Burkina Faso (working with the Burkinab&eacute; government on a speech-to-text tool for low-literacy access to government services); the <strong>TAIRI Lab at the University of Rwanda</strong> focuses on agriculture, health, and the environment; <strong>Dedan Kimathi University&#39;s Centre for Data Science and AI</strong> in Kenya works on environmental, health, and agricultural responsible-AI innovations; and the newest addition, the <strong>African Hub on AI Safety, Peace and Security</strong>, is anchored at UCT and co-led with the Global Center on AI Governance &mdash; the only lab in the network dedicated to policy and governance.</p>
      <p><strong>Innovation research networks.</strong> Five thematic networks coordinate cross-institutional work: <em>AI for Climate Action</em> (lead: WASCAL, Ghana; partners: RUFORUM in Uganda, AKADEMIYA2063 in Rwanda/Senegal); <em>AI for Agriculture and Food Systems</em> (lead: ATPS, Nigeria; partners: ICIPE, Kumasi Hive); <em>AI for Education</em> (lead: University of Lagos; partners: Universit&eacute; d&#39;Abomey Calavi in Benin, Data Science Nigeria); the <em>Hub on AI for Sexual, Reproductive and Maternal Health</em> (lead: Infectious Disease Institute at Makerere, partners: Makerere AI Lab, Sunbird AI); and <em>AI for Gender Equality and Inclusion</em> (leads: IPAR Senegal, SunbirdAI Uganda, CSEA Nigeria). Ecosystem-support partners include <em>Villgro Africa</em> (entrepreneur grants) and a joint <em>Data Science Africa &times; Deep Learning Indaba</em> early-career research awards programme.</p>
      <p>Why this matters here: when 11.4 referred to &ldquo;AI4D-affiliated labs&rdquo;, this is the network. It is also the cleanest example of how Northern public funding (IDRC, Sida, FCDO) flows into specific named African research infrastructure rather than into individual researchers, and a useful counterpoint to the brain-drain framing below &mdash; the network is explicitly designed to keep talent on the continent inside funded institutional homes.</p>
  ...
  <div class="resource-placeholder">
    ...
    <p><strong>AI4D Africa &amp; <em>Responsible AI, Empowering People</em>.</strong> Programme home: <a href="https://ai4d.ai" target="_blank" rel="noopener">ai4d.ai</a>; IDRC overview: <a href="https://idrc-crdi.ca/en/initiative/artificial-intelligence-development" target="_blank" rel="noopener">idrc-crdi.ca</a>; partner roster (innovation research networks): <a href="https://idrc-crdi.ca/en/research-in-action/meet-ai4d-africa-partners-leading-innovation-research" target="_blank" rel="noopener">Meet the AI4D Africa partners</a>; multidisciplinary university labs call (with lab details): <a href="https://ai4d.ai/calls/multidisciplinary-ai4d-labs/" target="_blank" rel="noopener">ai4d.ai/calls</a>.</p>
