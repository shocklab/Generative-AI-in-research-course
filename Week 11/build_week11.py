...
SL6_BODY = """
  ...
  <div class="card-grid">
    ...
    <div class="card">
      ...
      <p>The funded research network behind <strong>IDRC AI4D Africa</strong> (and now its global phase 2, <em>Responsible AI, Empowering People</em>, with FCDO and continued Sida participation) supports <strong>13 multidisciplinary AI labs &mdash; research labs and innovation labs combined &mdash; across the continent</strong>, plus a parallel layer of thematic innovation hubs and policy hubs. The labs cover Anglophone and Francophone Africa, span institutions in eleven countries, and include the recently-launched African Hub on AI Safety, Peace and Security (anchored at UCT, co-led with the Global Center on AI Governance) as the network&#39;s policy-and-governance node.</p>
      <p>When 11.4 referred to &ldquo;AI4D-affiliated labs&rdquo;, this is the network it meant. It is also the cleanest example in the institutional landscape of Northern public funding (IDRC, Sida, FCDO) flowing into specific named African research infrastructure rather than into individual researchers &mdash; and a counterpoint to the brain-drain framing below, since the network is explicitly designed to keep talent on the continent inside funded institutional homes.</p>
