...
SL1_BODY = """
  ...
  <div class="technical-detail">
    ...
    <ul class="styled-list" style="margin-top: 0;">
      ...
      <li><strong>Andrej Karpathy, public notes on agentic coding.</strong> Karpathy&#39;s widely-cited posts on agentic coding tools describe much the same phenomenon: that the tedious-task floor of programming has effectively collapsed and that the work has shifted toward architecture, system design, and the kinds of complex judgement that used to feel like the &ldquo;hard part&rdquo;. Informal source, but representative.</li>
      <li><strong>Ethan Mollick, <em>On Working with Wizards</em></strong> (September 2025) and the <em>Four Singularities for Research</em> piece (One Useful Thing). Mollick&#39;s argument is that agentic AI systems have shifted from collaborative &ldquo;co-intelligence&rdquo; partners (which expose their reasoning as they work) to autonomous &ldquo;wizards&rdquo; that produce sophisticated outputs through opaque processes &mdash; <em>"competence and opacity rise together"</em>. His worked example is using GPT-5 Pro to critique his own published job-market paper; the system ran independent verification code and surfaced a previously undetected error in his linked data tables. Mollick&#39;s broader framework is in his 2024 book <em>Co-Intelligence: Living and Working with AI</em> (Penguin), which is now the most-cited single-volume practitioner treatment of the topic.</li>
    </ul>
  ...
  <div class="resource-placeholder">
    ...
    <p><strong>Mollick, E. (September 2025).</strong> <em>On Working with Wizards.</em> One Useful Thing. <a href="https://www.oneusefulthing.org/p/on-working-with-wizards" target="_blank" rel="noopener">oneusefulthing.org</a>. See also <em>Four Singularities for Research</em> (<a href="https://www.oneusefulthing.org/p/four-singularities-for-research" target="_blank" rel="noopener">link</a>) and the 2024 book <em>Co-Intelligence: Living and Working with AI</em> (Penguin).</p>
  </div>
