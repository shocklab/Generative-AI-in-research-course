...
SL1_BODY = """
  ...
  <div class="technical-detail">
    ...
    <p style="color: #444; line-height: 1.75; margin-top: 12px;">A useful empirical complement: across recent industry-scale studies (Stack Overflow Developer Survey 2025, JetBrains AI Pulse January 2026, Google DORA 2025), controlled measurements of time savings from agentic coding tools cluster in the <strong>13&ndash;55% range</strong> on real work tasks &mdash; not on toy benchmarks. The headline benchmark trajectory (SWE-bench Verified rising from ~2% to ~78% between October 2023 and April 2026) provides the capability ceiling; the developer surveys provide the operational reality.</p>
  </div>
