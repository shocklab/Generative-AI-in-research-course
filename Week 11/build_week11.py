...
SL5_BODY = """
  ...
  <div class="technical-detail">
    ...
    <p style="color: #444; line-height: 1.75;"><strong>MzansiLM</strong> (<a href="https://arxiv.org/abs/2603.20732" target="_blank" rel="noopener">arXiv:2603.20732</a>, 21 March 2026; accepted at LREC 2026). Authors: Anri Lombard (lead), Simbarashe Mawere, Temi Aina, Ethan Wolff, Sbonelo Gumede, Elan Novick, Francois Meyer, Jan Buys. The arXiv listing does not display institutional affiliations directly; the team is associated with the UCT NLP group (Francois Meyer and Jan Buys are UCT NLP faculty). 125M-parameter decoder-only model trained from scratch alongside the accompanying <strong>MzansiText</strong> corpus. Covers all <em>eleven</em> official South African written languages: Sepedi, Sesotho, Setswana, siSwati, Tshivenda, Xitsonga, Afrikaans, English, isiNdebele, isiXhosa, and isiZulu. Reports 20.65 BLEU on isiXhosa data-to-text generation. This is the UCT contribution to the African sovereign-LM lineage and is exactly the kind of work this course&#39;s students may go on to do.</p>
  </div>
