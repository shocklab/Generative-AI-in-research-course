...
SL1_BODY = """
  ...
  <div class="card-grid">
    ...
    <div class="card">
      ...
      <p style="color: #888; font-size: 0.95em;">Test: does the abstract say something noticeably more careful than the press release? If yes, the press release is overclaimed.</p>
    </div>
    <div class="card">
      <h3>&#128640; Aspirational</h3>
  ...
  <p style="color: #555; line-height: 1.75; margin-bottom: 15px;">The rest of this sub-lesson is a worked example of the frame in action. We will take three concrete cases, one in each bucket, and trace each one from its primary source to its public reception.</p>

  <h2 class="section-title">&#9989; Real: What Is Actually Shipping in Research-AI</h2>

  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">Four lines of work, all peer-reviewed, all with humans verifying outputs in a laboratory, give the clearest <em>publishable</em> picture of what AI is currently contributing to active scientific research. They are not the whole picture (we return below to a second, more diffuse, and arguably larger category of AI-as-collaborator that does not yet fit inside a single headline paper) but they are a good place to anchor a discussion of what is actually working.</p>

  <div class="card-grid">
    <div class="card">
      <h3>Protein structure prediction</h3>
      <p>The AlphaFold lineage is an AI capability that is now infrastructure. AlphaFold 3 (Abramson et al., <em>Nature</em>, May 2024) extended the protein-only prediction of AlphaFold 2 to complexes including nucleic acids, small molecules and ions; code and weights were opened to academic users in November 2024. Structural biologists no longer treat predicted structures as exotic.</p>
  ...
  <div class="technical-detail">
    ...
    <p style="color: #444; line-height: 1.75; margin-bottom: 12px;">Then there are the three wet-lab biomedical validations published alongside:</p>
    <ul class="styled-list" style="margin-top: 0;">
      ...
      <li><strong>A bacterial-evolution mechanism.</strong> Co-Scientist proposed, in two days and with only minimal background information, that capsid-forming phage-inducible chromosomal islands interact with diverse phage tails to expand bacterial host range, matching the primary discovery of an independent, co-timed experimental study from the Pen&aacute;d&eacute;s group at the Fleming Initiative / Imperial College London (Pen&aacute;d&eacute;s et al., <em>Cell</em> 188(23), 6654&ndash;6665, 2025) before peer review of either was complete.</li>
    </ul>
    <p style="color: #444; line-height: 1.75; margin-top: 12px;">What made this work: AI-generated hypotheses, prioritised by oncologists and microbiologists, validated in physical experiments by named human collaborators, with the failures (drugs that didn&#39;t work, hypotheses that were rejected) reported alongside the successes.</p>
  </div>

  <p style="color: #555; line-height: 1.75; margin-bottom: 15px;">The Co-Scientist paper&#39;s own limitations section is worth reading for its calibration. The authors flag that the system&#39;s knowledge is constrained by open-access literature, that there is a systemic lack of access to negative experimental results, and that the validation reported is preliminary. The closing warning, that improper use of such systems without rigorous peer review and guardrails could worsen the scientific reproducibility crisis through low-quality scientific artefacts, is from the authors themselves, in <em>Nature</em>. Most press coverage of the same work does not read that way.</p>

  <div class="technical-detail">
    <h4>&#129504; Beyond the headline papers: AI as a workflow-level collaborator</h4>
    <p style="color: #444; line-height: 1.75; margin-bottom: 12px;">The four examples above are the clearest <em>publishable</em> demonstrations of what AI now contributes to research. They share a property that makes them legible: each one fits inside a single paper, with a single primary result. There is also a second category of &ldquo;AI as collaborator&rdquo; that is harder to point at in headline form and arguably bigger in aggregate effect.</p>
    <p style="color: #444; line-height: 1.75; margin-bottom: 12px;">Agentic coding tools (<em>Claude Code</em>, <em>Codex</em>, <em>Cursor</em>&#39;s agent modes) have moved over the last twelve months from completing one line of code at a time to running for hours on complex, multi-step research tasks. Used by individual researchers with strong domain judgement and the verification habits covered in Weeks 9 and 10, these tools now support experimental code drafting, multi-stage data analysis, theoretical reasoning, debugging across substantial codebases, and large parts of manuscript construction, well beyond the literature search and code completion the early framing of &ldquo;AI as narrow-task assistant&rdquo; suggested. Practitioners report that intellectually demanding work which previously took months can sometimes be compressed into days or weeks. Much of the active researcher community now describes agentic coding tools as the largest change AI has made to their day-to-day research practice.</p>
    <p style="color: #444; line-height: 1.75; margin-bottom: 12px;">This category is harder to evaluate than the four lab-scale examples because the productivity depends substantially on the researcher: their existing domain skill, their willingness to verify outputs at every meaningful junction, and their judgement about which parts of the work they will and will not delegate. Two researchers using identical tools can have wildly different experiences. The bottleneck for many active researchers is no longer the tool&#39;s capability but their own practice around it. For students reading this from the start of their research careers, getting the practice right is now a first-order skill.</p>
    <p style="color: #444; line-height: 1.75;">Sources worth reading first-hand on what this looks like in practice:</p>
    <ul class="styled-list" style="margin-top: 0;">
      <li><strong>Patrick Mineault, <em>Claude Code for Scientists</em></strong> (2026). The single best practitioner write-up of how agentic coding has changed day-to-day neuroscience research workflow, from a working scientist. <a href="https://www.neuroai.science/p/claude-code-for-scientists" target="_blank" rel="noopener">neuroai.science</a>.</li>
      <li><strong>Anthropic, <em>Coding Agents in the Social Sciences</em></strong> (March 2026). The baseline survey wave of an ongoing randomised study, sampling 1,260 quantitative social scientists. The headline numbers as of the baseline: 20% of surveyed researchers use coding agents regularly; 97% of those users apply them to data-analysis code; users report starting more projects than non-users at the same career stage. <a href="https://www.anthropic.com/research/coding-agents-social-sciences" target="_blank" rel="noopener">anthropic.com</a>.</li>
      <li><strong>Ethan Mollick, three essays on One Useful Thing</strong> track the recent shift from human-AI &ldquo;co-intelligence&rdquo; (humans and AI prompting back-and-forth) to humans managing autonomous agents. <em>On Working with Wizards</em> (11 September 2025) introduces the &ldquo;wizard&rdquo; frame (AI systems that produce sophisticated outputs through opaque processes), with the line <em>&ldquo;competence and opacity rise together&rdquo;</em>. Mollick&#39;s worked example is using GPT-5 Pro to critique his own published job-market paper; the system ran its own verification code (including Monte Carlo analysis) and found a previously unnoticed error linking two tables in the paper that no human reviewer had spotted. <em>Claude Code and What Comes Next</em> (8 January 2026) is the most directly relevant essay for postgraduate researchers experimenting with agentic coding tools, and quotes Andrej Karpathy: <em>&ldquo;the profession is being dramatically refactored as the bits contributed by the programmer are increasingly sparse and between. I have a sense that I could be 10X more powerful if I just properly string together what has become available over the last ~year and a failure to claim the boost feels decidedly like skill issue.&rdquo;</em> <em>The Shape of the Thing</em> (12 March 2026) sets out the broader trajectory and the StrongDM &ldquo;Software Factory&rdquo; case: a three-person team running an AI-only production-software pipeline under two pre-commitments (&ldquo;Code must not be written by humans&rdquo; / &ldquo;Code must not be reviewed by humans&rdquo;), with each human engineer spending roughly $1,000 per day on AI tokens. Mollick&#39;s 2024 book <em>Co-Intelligence: Living and Working with AI</em> (Penguin) is the standing single-volume background. <a href="https://www.oneusefulthing.org/p/on-working-with-wizards" target="_blank" rel="noopener">Wizards</a> &middot; <a href="https://www.oneusefulthing.org/p/claude-code-and-what-comes-next" target="_blank" rel="noopener">Claude Code</a> &middot; <a href="https://www.oneusefulthing.org/p/the-shape-of-the-thing" target="_blank" rel="noopener">Shape of the Thing</a>.</li>
    </ul>
    <p style="color: #444; line-height: 1.75; margin-top: 12px;">A useful empirical complement: across recent industry-scale studies (Stack Overflow Developer Survey 2025, JetBrains AI Pulse January 2026, Google DORA 2025), controlled measurements of time savings from agentic coding tools cluster in the <strong>13&ndash;55% range</strong> on real work tasks rather than toy benchmarks. The headline benchmark trajectory (the original SWE-bench scoring ~2% of issues in 2023, with SWE-bench Verified reaching ~88% by 2026) provides the capability ceiling; the developer surveys provide the operational reality.</p>
  </div>

  <div class="info-box">
    <h4>&#128270; What &ldquo;real&rdquo; looks like up close</h4>
    <p>When a paper makes a striking AI-in-science claim, read the <em>limitations</em> section before reading the abstract. Authors usually mark the boundary of their own claim honestly. Press coverage strips that boundary out. The gap between what the discussion section says and what the headline says is a reliable signal for separating real from overclaimed.</p>
  </div>

  <h2 class="section-title">&#9888;&#65039; Overclaimed: A Detailed Case Study</h2>

  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">Now we take a single, recent, high-profile result, the Sakana AI &ldquo;AI Scientist&rdquo; paper in <em>Nature</em> in March 2026, and trace what it actually says, what the public coverage said it said, and what the gap between those two looks like. This is a worked exercise, not a takedown. The underlying paper is interesting and the authors are careful. The point is that even careful, peer-reviewed work gets routinely rounded up in transit.</p>

  <div class="case-study">
    <h4>&#128209; What the Sakana paper actually claims</h4>
    <p>Lu, C., Lu, C., Lange, R. T., Yamada, Y. et al. (2026). <em>Towards end-to-end automation of AI research.</em> <em>Nature</em> 651, 914&ndash;919, DOI 10.1038/s41586-026-10265-5. CC&nbsp;BY 4.0 open access. Note the actual title. The lab blog framing was &ldquo;<em>The AI Scientist: Towards Fully Automated AI Research</em>&rdquo;; the published title is the more modest <em>Towards end-to-end automation of AI research</em>.</p>
  ...
  <div class="card-grid">
    ...
    <div class="card">
      ...
      <p>The journals you would want to publish in (<em>Nature</em>, <em>Science</em>, the medical journals, the African Journal of Marine Science) do not permit AI to be listed as an author, and have ethics policies under the International Committee of Medical Journal Editors and the Committee on Publication Ethics that make AI authorship a misconduct matter (we look at these in 11.3). Even the Sakana paper&#39;s headline AI-generated workshop manuscript was withdrawn rather than published. The notion of AI as first author is not a near-term operational reality.</p>
  ...
  <div class="highlight-box">
    ...
    <p>You do not need a confident prediction about whether AI will replace researchers in 2030. You need a habit: when you read a claim about what AI is doing for science, ask which bucket it belongs in (real, overclaimed, or aspirational) and pull the primary source if you cannot tell.</p>
  ...
  <ol class="step-list">
    ...
    <li><strong>Find the primary source.</strong> Not a press release, not a blog post, not a news article, but the peer-reviewed paper or the verified preprint. Look at the abstract, the limitations section, and the figure captions.</li>
  ...
  <div class="resource-placeholder">
    ...
    <p><strong>Mineault, P. (2026).</strong> <em>Claude Code for Scientists.</em> <a href="https://www.neuroai.science/p/claude-code-for-scientists" target="_blank" rel="noopener">neuroai.science</a>. Practitioner write-up of how agentic coding has changed day-to-day neuroscience research workflow.</p>
    <p><strong>Anthropic (March 2026).</strong> <em>Coding Agents in the Social Sciences.</em> Baseline wave of a randomised study, 1,260 quantitative social scientists surveyed. <a href="https://www.anthropic.com/research/coding-agents-social-sciences" target="_blank" rel="noopener">anthropic.com</a>.</p>
    <p><strong>Mollick, E.</strong> Three essays on One Useful Thing tracking the shift from human-AI co-intelligence to humans managing autonomous agents: <em>On Working with Wizards</em> (11 September 2025), <a href="https://www.oneusefulthing.org/p/on-working-with-wizards" target="_blank" rel="noopener">link</a>; <em>Claude Code and What Comes Next</em> (8 January 2026), <a href="https://www.oneusefulthing.org/p/claude-code-and-what-comes-next" target="_blank" rel="noopener">link</a>; <em>The Shape of the Thing</em> (12 March 2026), <a href="https://www.oneusefulthing.org/p/the-shape-of-the-thing" target="_blank" rel="noopener">link</a>. Background book: <em>Co-Intelligence: Living and Working with AI</em> (Penguin, 2024).</p>
  </div>

  <p style="color: #555; line-height: 1.75; margin-top: 20px; margin-bottom: 15px;"><strong>Coming up in 11.2:</strong> a reading guide for the genuinely <em>speculative</em> end of the AI-in-research literature: frameworks (Krenn, Wang, Morris), falsifiable forecasts (METR), institutional visioning (Royal Society, Africa Declaration), and wild speculation (Clune, <em>AI 2027</em>, Russell), with the same calibration habit applied throughout. 11.3 then turns from speculation to the institutional present: what journals and funders have actually <em>done</em> in response to AI in research, and the gap between policy and practice.</p>
"""
...
SL_SUPP_BODY = """
  <div class="intro-text">
    <h2>&#127919; What We&#39;ll Cover</h2>
    <p>Sub-Lesson 11.1 stayed inside the present and the very near term: results that are already shipping or that look highly likely to land within the next year, and that you can therefore check against primary sources today. This sub-lesson takes the same calibrated reading habit and applies it to the genuinely <em>speculative</em> end of the AI-in-research literature, the work that asks not &ldquo;what does AI do for science now?&rdquo; but &ldquo;what could AI do for science, eventually, and what would that change?&rdquo; Five years out is unknowable territory, and the framework of 11.1 stops well short of it.</p>
    <p>The calibration habit from 11.1 still applies here, only more strongly. Confident sentences about 2030 are rarely better-grounded than confident sentences about 2026. Several of the works in this guide are serious academic frameworks; a couple are essentially structured science fiction with a confident tone. The lesson is organised so you can tell them apart.</p>
    <p>The goal is not to make you a forecaster. It is to give you a working reading guide for the question &ldquo;what kind of researcher do I want to be in a world where this stuff keeps moving?&rdquo;, which underlies much of the rest of this week.</p>
  </div>
  ...
  <div class="card-grid">
    <div class="card">
      ...
      <p>The paper itself classifies the third dimension as &ldquo;the ultimate, not yet existent&rdquo; capability. Read it for the calibrated framing as much as for the framework.</p>
    ...
    <div class="card">
      ...
      <p>Wang and colleagues, in <em>Nature</em>, map AI&#39;s emerging role across every stage of the scientific process: hypothesis generation, experiment design, data collection, analysis, interpretation. The paper is a landscape rather than a manifesto, useful for orienting yourself before reading any of the more polemical speculative work.</p>
      <p>It is clear-eyed that &ldquo;AI in science&rdquo; is not one thing: protein structure prediction, materials discovery, automated chemistry, and LLM-assisted writing all sit at different levels of maturity and need to be evaluated separately.</p>
    ...
    <div class="card">
      ...
      <p>A DeepMind team led by Meredith Ringel Morris, with Shane Legg among the authors, proposes a six-level framework for AGI capability, indexed jointly by performance (depth) and generality (breadth), explicitly analogous to the SAE levels of autonomous driving. The framework avoids putting a date on any level.</p>
      <p>It is useful because it refuses to commit to a timeline. When you read confident claims about &ldquo;AGI by 2027&rdquo;, this paper is what such claims are pretending to be.</p>
  ...
  <div class="technical-detail">
    ...
    <p style="color: #444; line-height: 1.75; margin-bottom: 12px;">The endpoints of the curve in the March 2025 paper are striking: from GPT-2 in 2019 (a 50% horizon of seconds) up to Claude 3.7 Sonnet in early 2025 (around 50 minutes). METR maintains an updated &ldquo;Time Horizon&rdquo; dataset with newer models and a larger task suite; for current figures, check METR&#39;s own tracker directly rather than the often-inflated numbers that circulate in secondary news coverage. That check is itself an instance of this lesson&#39;s central habit.</p>
    <p style="color: #444; line-height: 1.75; margin-top: 12px;">Extrapolated naively, the curve says that within a decade AI systems will be able to autonomously complete the kind of software work that today takes a person days or weeks. The caveat the METR team itself flags is that exponential curves bend (nothing in nature stays exponential forever) and they are not predicting <em>when</em> the bend will happen.</p>
    <p style="color: #444; line-height: 1.75;">Why read it: it is a falsifiable forecast in a literature short on them. By 2028 we will know whether the 7-month doubling held; that is more than can be said for most predictions in this area. <em>METR (March 2025). Measuring AI Ability to Complete Long Software Tasks. arXiv:2503.14499.</em></p>
  </div>
  ...
  <p style="color: #555; line-height: 1.75; margin-bottom: 15px;">Adjacent to METR is the body of work from <strong>Epoch AI</strong>, an organisation focused on training-compute scaling, dataset-size trends, and the economics of frontier model training. Their forecasts share METR&#39;s strength (quantitative and refutable) and weakness (extrapolation without a mechanism). Worth reading if you want the technical version of &ldquo;how big might AI training get?&rdquo;</p>

  <h2 class="section-title">&#127960;&#65039; C. Institutional Visioning</h2>

  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">This category is easy to overlook, because it is what the bodies that <em>set rules</em> (learned societies, national academies, intergovernmental panels) think research is going to look like. These documents move slowly and read carefully, but they are the speculative pieces that translate most directly into actual policy.</p>

  <div class="technical-detail">
    <h4>&#128218; <em>Science in the age of AI</em> (Royal Society, May 2024)</h4>
    ...
    <p style="color: #444; line-height: 1.75; margin-bottom: 12px;">Read it for its tone, which is what speculative-futures discourse sounds like when written by a body that takes responsibility for science as an institution rather than as a market.</p>
  ...
  <div class="card-grid">
    ...
    <div class="card">
      ...
      <p>Two notes. The authors themselves estimate roughly 50% probability that the superhuman-coder milestone is missed on the 2027 timeline, and Kokotajlo&#39;s own median forecast has since shifted to &ldquo;around 2030, lots of uncertainty though&rdquo;. Critics describe parts of the scenario as closer to science fiction than forecasting. Worth reading as a specimen of confident-tone speculation, the kind of document the reading habit from 11.1 is built for.</p>
    ...
    <div class="card">
      ...
      <p>Almost everything else in this bucket argues, in one register or another, that AI is on a steep trajectory toward major or general capability. The most prominent serious work arguing the <em>opposite</em> is Arvind Narayanan and Sayash Kapoor&#39;s essay &ldquo;AI as Normal Technology&rdquo;, by the authors of the <em>AI Snake Oil</em> book and newsletter (whom you met in Week 7). They argue that AI is best understood like electricity or the internet: genuinely major over decades, but diffusing through the economy at the ordinary, friction-bound pace of any general-purpose technology, not as an imminent &ldquo;superintelligence&rdquo; discontinuity.</p>
      <p>It is the counterweight: a reading guide that only lists escalating-capability speculation is itself miscalibrated. Read it against <em>AI 2027</em> in particular (same near-future, opposite priors) and see which of the two gives you more ways to check it later.</p>
  ...
  <div class="highlight-box">
    ...
    <p>If a piece of futures work would not change anything its author does if it turned out to be wrong, it is closer to fiction than forecasting. That is not a reason to ignore it, since serious fiction can be useful, but it is a reason to read it differently from a piece of work the author would defend on the same terms as their other research.</p>
  </div>
  ...
  <p style="color: #555; line-height: 1.75; margin-top: 20px; margin-bottom: 15px;">That second sentence, what would change your mind, sits at the centre of the calibrated reading habit. A speculative work that gives you no way to check it later is a work you should hold loosely. One that does is a work you can engage with on the same terms as any other piece of research.</p>
...
SL3_BODY = """
  <div class="intro-text">
    <h2>&#127919; What We&#39;ll Cover</h2>
    <p>In the eighteen months between January 2024 and mid-2026, the institutions that govern academic research &mdash; journals, learned societies, public funders, conference organisers &mdash; have pushed out more new rules about AI use than in any comparable period in their history. By August 2025, around <strong>83% of high-impact journals</strong> had a policy on AI use in peer review (up from 77% in March); around <strong>70% of journals across all impact tiers</strong> had a policy on AI use by authors (Wang &amp; Gong, <em>Learned Publishing</em>, March 2026, <a href="https://doi.org/10.1002/leap.2035" target="_blank" rel="noopener">DOI 10.1002/leap.2035</a>; see &ldquo;Sources&rdquo; below for the full methodology). The institutional response, by any standard, has been fast.</p>
    <p>And yet, in the same period, the practice gap has stayed almost flat. Of more than 75,000 papers published since 2023 that He &amp; Bu (<em>PNAS</em>, March 2026, <a href="https://doi.org/10.1073/pnas.2526734123" target="_blank" rel="noopener">DOI 10.1073/pnas.2526734123</a>) examined in full text, only <strong>about 0.1% explicitly disclosed AI use</strong>. Journals with and without AI policies show statistically indistinguishable growth in detectable AI-written content. The rules have moved; researcher behaviour has not.</p>
    <p>This sub-lesson maps the new institutional landscape in the form a postgraduate researcher actually has to navigate it. We look in turn at the policies that bind <em>authors</em>, those that bind <em>reviewers</em>, those that bind <em>grant applicants</em> (with a particular note on where the South African NRF sits, which is &ldquo;nowhere yet&rdquo;) and then at the detection-and-integrity layer that has emerged in parallel. We close with a short exercise that connects the two halves of the picture: by the time you submit your first paper, you should already know what each of the institutions you are submitting to will require of you.</p>
  </div>
  ...
  <p style="color: #555; line-height: 1.75; margin-bottom: 15px;">A less-noticed pattern in Wang and Gong&#39;s data bears on whether the rules are actually being implemented. The proportion of high-impact journals with AI policies <em>specifically for editors</em> (the people inside the publishing system, as distinct from the external reviewers) rose from <strong>41% in March 2025 to 64.3% in August 2025</strong>: a 23-percentage-point jump in five months in the segment of policy that addresses what the publishing infrastructure itself is allowed to do. This part of the institutional response has been moving fastest while getting the least public coverage.</p>
  ...
  <div class="technical-detail">
    ...
    <ul class="styled-list" style="margin-top: 0;">
      ...
      <li><strong>Parallel growth curves.</strong> AI-content levels grow at <em>statistically the same rate</em> in journals that have AI policies and in journals that do not (Mann-Whitney U tests; no significant difference). The presence of a policy is not slowing the adoption of AI writing.</li>
    </ul>
  ...
  <p style="color: #555; line-height: 1.75; margin-bottom: 15px;">The He &amp; Bu finding is not that policies are pointless. The authors are explicit that the modest rise in disclosures, even from 0.01% to 0.43%, suggests policies are slowly shifting a small subset of researchers toward transparency. What policies are <em>not</em> doing is curbing the underlying use. The gap between policy and practice, in their data, is roughly an order of magnitude wider than the policy-revision activity has been able to close.</p>

  <div class="info-box">
    <h4>&#128221; A meta-touch worth noting</h4>
    <p>He &amp; Bu themselves declare their own AI use in the methods section: they used ChatGPT-4o-mini and Gemini 2.5 Flash via API for large-scale data processing and Claude (the conversational interface) for qualitative auditing and logic checks. The paper that catalogues how few researchers disclose AI use models good practice itself, and shows what the disclosure norm looks like in actual operation.</p>
  </div>

  <h2 class="section-title">&#128270; The Detection-and-Integrity Layer</h2>

  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">In parallel with the policy surge, a small industry of AI-content detection tools and academic-integrity research has grown up to try to enforce, or at least measure, what the policies require. The key point about this layer is that <em>detection does not work reliably enough to be the front line of integrity</em>. The institutional rules will continue to depend, in the end, on disclosure by authors and on the social norms in research communities. Detection plays a supporting role; it is not a substitute.</p>
  ...
  <div class="card-grid">
    ...
    <div class="card">
      ...
      <p>Callanan and colleagues analysed 3,374 orthopaedic manuscripts published after the release of ChatGPT, using a 32.875% AI-detection threshold calibrated against 300 pre-AI-era (year 2000) baseline manuscripts. They report that <strong>16.7% of post-ChatGPT manuscripts</strong> exceeded that significance threshold overall, with journal-specific rates ranging from 5.6% (<em>American Journal of Sports Medicine</em>) up to <strong>38.3%</strong> (<em>Journal of Bone &amp; Joint Surgery</em>). The figure is method-dependent &mdash; ZeroGPT is the underlying detector &mdash; but it remains one of the highest credible journal-specific estimates in print.</p>
      <p>Useful: gives a sense of upper-bound prevalence and a calibrated baseline-correction method. Limited: detector-dependent; ZeroGPT&#39;s false-positive characteristics still apply.</p>
      <p style="color: #888; font-size: 0.9em;">Callanan, T., Marquez, J., Pisani, C. et al. (2025). <em>J Bone Joint Surg Am</em> 107(16), 1887&ndash;1893. <a href="https://doi.org/10.2106/JBJS.24.01462" target="_blank" rel="noopener">DOI 10.2106/JBJS.24.01462</a>.</p>
    </div>
    <div class="card">
  ...
  <div class="case-study">
    ...
    <p>In July 2025, <em>Nikkei Asia</em> reported that researchers had begun embedding hidden instructions in academic preprints, in white text, in microscopic fonts, or in metadata, instructing any AI reviewer that processed the paper to produce a positive review. The original investigation identified <strong>17 papers on arXiv</strong> with such hidden prompts; the lead authors were affiliated with <strong>14 institutions in 8 countries</strong>, including Waseda University, KAIST, Peking University, the National University of Singapore, the University of Washington, and Columbia University.</p>
    ...
    <p>The finding works as a teaching moment. It shows simultaneously: (i) that the rules against using AI to review papers are not being uniformly followed; (ii) that some researchers are actively gaming the rules they expect their colleagues are violating; (iii) that the only durable defence is a human reviewer actually reading the paper. Detection, in the technical sense, was not what caught these prompts; an investigative reporter did.</p>
  ...
  <div class="resource-placeholder">
    ...
    <p><strong>Callanan, T., Marquez, J., Pisani, C. et al. (2025).</strong> Evaluating Artificial Intelligence-Based Writing Assistance Among Published Orthopaedic Studies: Detection and Trends for Future Interpretation. <em>Journal of Bone &amp; Joint Surgery</em> 107(16), 1887&ndash;1893. <a href="https://doi.org/10.2106/JBJS.24.01462" target="_blank" rel="noopener">DOI 10.2106/JBJS.24.01462</a>.</p>
  ...
  <p style="color: #555; line-height: 1.75; margin-top: 20px; margin-bottom: 15px;"><strong>Coming up in 11.4:</strong> we turn from the institutional landscape to the structural foundations of African AI sovereignty, defining what &ldquo;sovereign AI capacity&rdquo; means across five layers, and then going deep on the one that everything else depends on: compute. The South African CHPC, the Cassava&ndash;NVIDIA AI Factory, the stalled Microsoft&ndash;G42 Kenya deal, and the gap between what has been announced and what is actually built.</p>
"""
...
SL4_BODY = """
  ...
  <div class="intro-text">
    ...
    <p>This sub-lesson reads sovereign AI from an African intellectual tradition first (from Mhlambi, Effoduh, the Esethu Framework, Mutung&#39;u and colleagues, and the AU&#39;s own strategy) and then evaluates the better-known vendor and Northern-analytical framings against that home base. The pedagogical claim is not that the African tradition is correct and the others are wrong, but that the relational conception of sovereignty that runs through African scholarship gives postgraduate researchers in this part of the world a strong analytical tool for thinking about the AI infrastructure they are about to live with.</p>
  ...
  <div class="card-grid">
    <div class="card">
      ...
      <p>Sabelo Mhlambi&#39;s Carr Center discussion paper <em>From Rationality to Relationality</em> argues that contemporary AI was built on a Western philosophical view of personhood as rationality, and that this view&#39;s contradictions are reproduced as the harms AI causes. Mhlambi proposes Ubuntu&#39;s relational personhood (personhood as a property of the relations between people rather than of an individual&#39;s capacity to reason) as an alternative substrate for AI ethics.</p>
  ...
  <p style="color: #555; line-height: 1.75; margin-bottom: 15px;">Two more strands sit alongside these. <strong>The CARE Principles</strong> (Collective Benefit, Authority to Control, Responsibility, Ethics) were drafted in Gaborone in 2018 at International Data Week, by the Global Indigenous Data Alliance, and have become the most-cited framework worldwide for Indigenous data sovereignty. The CARE Principles complement rather than replace the more familiar FAIR Principles (findable, accessible, interoperable, reusable): FAIR governs the data; CARE governs the relations between the data and the communities the data come from. The geographic anchor of the framework in Africa, and its conceptual closeness to the relational reading of sovereignty in Mhlambi and Esethu, makes CARE a natural companion to the African strand. <strong>The African Union Continental AI Strategy</strong> (July 2024), for its part, talks about sovereignty in its policy-document register: less analytically sharp than the academic papers above, but nonetheless committed to the principle that African AI capacity should be developed under African terms.</p>

  <div class="info-box">
    <h4>&#128101; The working community behind these positions</h4>
    <p>The African sovereign-AI conversation we are reading here is sustained by a working community of researchers and engineers rather than by a few named figures, and it is worth being explicit about that. The most directly relevant network runs through three overlapping institutions: <strong>Masakhane</strong> (the African-NLP grassroots community established around 2019); <strong>Lelapa AI</strong> (the Johannesburg-based company, co-founded in 2022 by <strong>Pelonomi Moiloa</strong> [CEO], <strong>Jade Abbott</strong> [COO], <strong>Vukosi Marivate</strong>, <strong>Benjamin Rosman</strong>, <strong>Pravesh Ranchod</strong>, and <strong>George Konidaris</strong>, drawing on the Wits RAIL lab, UP&#39;s DSFSI, Brown University, and the Masakhane network); and the <strong>Deep Learning Indaba</strong> (founded 2017, the continent&#39;s most important annual AI gathering). The InkubaLM author list alone runs to eleven names (Tonja, Dossou, Ojo, Rajab, Thior, Wairagala, Aremu, Moiloa, Abbott, Marivate, Rosman), drawing across Masakhane, Lelapa, MBZUAI, and partner institutions; the Esethu Framework carries fifteen authors across Wits, Lelapa, and Masakhane; <strong>David Adelani</strong> (UCL/McGill) is among the most prolific Masakhane researchers and a regular author on most of the African-NLP benchmark stack we map in 11.5. Reading what follows as the work of two or three named individuals would misrepresent both the scale of the community and the way the argument is actually carried.</p>
    <p>That said, two specific public positions are foregrounded later in the sub-lesson and worth introducing here. The first is <strong>Moiloa&#39;s</strong> public case for <em>Resource-Efficient AI</em>: that African sovereign AI capacity is not best pursued by trying to replicate the compute footprint of Silicon Valley labs but by building models small enough and efficient enough that the available infrastructure can actually support them. The case appears most directly in the Lelapa blog piece <em>The Future of AI is Resource-Efficient and We&#39;re Building It</em> (Shikwambane, 8 January 2026, quoting Moiloa at length: <em>&ldquo;design for efficiency from the start&rdquo;</em>; <em>&ldquo;performance does not depend on scale alone&rdquo;</em>) and in her 2024 <em>Rest of World</em> interview (<em>&ldquo;Creating models that require fewer resources to train democratizes access for users and developers, which allows the benefits of the technology to be shared more broadly, rather than only being available to a select few who can afford the exorbitant costs.&rdquo;</em>). InkubaLM is the engineering expression. The second is the <strong>institutional recognition</strong> the community has accumulated outside its own publications: <strong>Marivate</strong>, ABSA Chair of Data Science at UP, was awarded the Order of Mapungubwe (Silver) in 2024 and seated on the UN Independent International Scientific Panel on AI in February 2026, as the most prominent African member of that 40-person panel &mdash; the anchor that gives the African sovereignty argument legibility in international policy debates. <a href="https://lelapa.ai/blog/the-future-of-ai-is-resource-efficient" target="_blank" rel="noopener">Lelapa blog</a> &middot; <a href="https://restofworld.org/2024/3-minutes-with-pelonomi-moiloa/" target="_blank" rel="noopener">Rest of World</a>.</p>
  </div>
  ...
  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">A useful test of the relational conception of sovereignty is a case the Mutung&#39;u, Martin, and Brewczy&#324;ska paper treats in detail. It is worth narrating briefly here because it shows the analytical move the African strand is making.</p>
  ...
  <div class="case-study">
    ...
    <p>The Mutung&#39;u et al. paper makes the analytical move that matters here. The Worldcoin violation was <em>not</em> caused by an absence of African GPUs, African foundation models, or African data centres. It was caused by a foreign company extracting biometric data from Kenyan individuals under terms those individuals were not in a position to evaluate, and by a regulator that did not have the institutional capacity to enforce its rules before the harm had already occurred at scale. A &ldquo;sovereign AI&rdquo; agenda framed primarily around <em>infrastructure ownership</em> (the version we will look at below in the vendor framing) would not have prevented this. A sovereignty agenda framed around <em>the prior duty of the state to protect individual digital rights</em>, which is the framing Mutung&#39;u and colleagues argue for, goes directly to where the violation actually occurred.</p>
  ...
  <div class="technical-detail">
    ...
    <p style="color: #444; line-height: 1.75;"><strong>Where it stands:</strong> CHPC is real, operational, and free at the point of use for South African postgraduate researchers. It is not, and is not designed as, a dedicated national AI compute facility. The upgrade is in procurement.</p>
  ...
  <div class="technical-detail">
    ...
    <p style="color: #444; line-height: 1.75;"><strong>Where it stands:</strong> the binding constraint here is not GPUs and not capital; it is grid capacity. We return to it below.</p>
  ...
  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">The binding constraint in the African compute picture, almost everywhere, is grid capacity rather than GPU supply. The Microsoft&ndash;G42 Kenya stall demonstrates it. Here is the arithmetic.</p>
  ...
  <div class="technical-detail">
    ...
    <ul class="styled-list" style="margin-top: 0;">
      ...
      <li>3,000 H100s, the kind of cluster the Cassava South African site is designed for, therefore draws roughly <strong>30 MW</strong> of IT load, with a further 5&ndash;10 MW for cooling. Cassava&#39;s 20 MW Johannesburg AI Factory site is sized to host roughly this scale.</li>
  ...
  <ul class="styled-list">
    ...
    <li><strong>Resource efficiency is a sovereignty practice.</strong> The Lelapa argument, that building smaller, more efficient models on accessible infrastructure is itself a sovereignty move, fits the current picture. InkubaLM, MzansiLM, and the other African foundation models we covered in Week 10 are examples of this strategy in practice.</li>
    <li><strong>Watch the continental-compute landscape, but plan around what you can use now.</strong> Several African higher-education-led compute initiatives are at various stages of standing-up, some institution-specific, some pan-continental, but as of May 2026 none of them are broadly available at the individual-researcher tier. The default for the next 12&ndash;18 months is the combination of DataSpires (Africa-located, individual-tier) plus the existing free-tier cloud options below, with CHPC as the South-Africa-specific fallback for academic use.</li>
    <li><strong>Think of compute as one of five layers, not as the whole picture.</strong> The Worldcoin case is the reminder. Even if every GPU you used was hosted in Africa under African ownership, that on its own would not guarantee that the rights of the people whose data the model was trained on were protected. The other layers (data governance, model evaluation, policy, and talent) are where the African sovereignty conversation does some of its most distinctive work. We cover them in 11.5 and 11.6.</li>
  </ul>
...
SL5_BODY = """
  ...
  <div class="info-box">
    ...
    <p>That number frames the whole African-model conversation. The space is vastly under-served; the work that exists matters because of how much more there is to do.</p>
  </div>
  ...
  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">For the postgraduate audience, the practical payoff is a concrete list of what is missing in the current African data-and-models landscape. Six gaps are particularly thesis-shaped: each one is a genuine research opening that could be pursued from a UCT or comparable position.</p>
  ...
  <p style="color: #555; line-height: 1.75; margin-bottom: 15px;">If you are a postgraduate looking for a thesis topic in this part of the AI landscape, any of these gaps is a real opening. Not because they are easy, but because the field will recognise the contribution.</p>
  ...
  <ul class="styled-list">
    ...
    <li><strong>Resource-efficient is a sovereignty practice.</strong> The Lelapa argument generalises: matching your work to the compute and data you actually have access to, rather than to the headline numbers of foreign labs, is the practical version of the sovereignty position covered in 11.4.</li>
  </ul>
  ...
  <p style="color: #555; line-height: 1.75; margin-top: 20px; margin-bottom: 15px;"><strong>Coming up in 11.6:</strong> we turn from data and models to the remaining two layers of the stack, policy and talent. The African Union Continental AI Strategy in its operational detail, the national strategies of South Africa / Kenya / Rwanda / Nigeria / Egypt (and the peer-reviewed comparative analysis in Yilma &amp; Wodajo&#39;s <em>Science and Public Policy</em> special section), and the institutional landscape of Deep Learning Indaba, AIMS, ARIN, and Lelapa as the talent pipeline. We close 11.6 with the question that opens Week 12 (the integrative capstone): given everything we now know about African AI capacity, what is the most useful thing a postgraduate in this room can actually do?</p>
"""
...
SL6_BODY = """
  ...
  <p style="color: #555; line-height: 1.75; margin-top: 20px; margin-bottom: 15px;">A consolidating analytical resource: Munga &amp; Quansah&#39;s September 2025 Carnegie piece <em>Understanding Africa&#39;s AI Governance Landscape</em> compares 15 national + 2 continental strategies and offers a clear map of the policy stack. Engida Abdella &amp; Alayande&#39;s April 2025 piece for the Global Center on AI Governance, <em>African Countries Are Racing to Create AI Strategies &mdash; But Are They Putting the Cart Before the Horse?</em>, provides the counterweight: many strategies skip foundational infrastructure questions, lack realistic implementation timelines, and rely on benefit-sharing rhetoric without operational mechanisms. CIPESA&#39;s 2025 SIFA report (<em>Navigating the Implications of AI on Digital Democracy in Africa</em>) draws on empirical research across 14 countries and is a strong empirical complement to the analytical work.</p>

  <h2 class="section-title">&#127479;&#127462; The South African AI Policy Withdrawal</h2>

  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">The most consequential recent event in African AI governance happened in South Africa in April 2026. It is worth treating in detail because it is at once an example of the Yilma &amp; Wodajo critique and a worked instance of the policy-and-practice problem we covered in 11.3. It also, for the students reading this from a UCT vantage point, happened in your own jurisdiction.</p>
  ...
  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">The answer in May 2026 is: <em>Big Tech capex and Northern foundations</em>. The sovereign and continental instruments are largely announced; the operational funding flows are largely commercial. This observation underpins everything in the second half of this sub-lesson.</p>
  ...
  <div class="highlight-box">
    ...
    <p>The plain summary of African AI funding in May 2026 is this: African AI capacity is currently being underwritten by Big Tech capital expenditure (Microsoft, Google, OpenAI / Gates) and Northern public-funder programmes (IDRC, FCDO via AI4D), not by sovereign or continental instruments. This is the Yilma &amp; Wodajo critique landing at the material level: the strategy-and-governance architecture announces intent; the cheques are signed by the firms and foundations whose dependencies the strategy is supposed to manage.</p>
    <p style="margin-top: 15px;">There are very good African-led organisations doing important work with these funds (Masakhane, Lelapa, AfriDSAI, the UCT ACI, ACTS, the Lacuna successor partnership) and noting where the money comes from is not a criticism of any of them. It is the empirical picture against which the policy positions in the rest of this sub-lesson should be read.</p>
  </div>
  ...
  <div class="card-grid">
    <div class="card">
      ...
      <p>Founded 2017 at Wits by an eight-person organising team: Shakir Mohamed and Ulrich Paquet (both DeepMind), Nyalleng Moorosi, Vukosi Marivate and Benjamin Rosman (all then CSIR), Stephan Gouws (Google Brain), Willie Brink (Stellenbosch) and Richard Klein (Wits). The continent&#39;s most important annual AI gathering. 2025 in Kigali (17&ndash;22 August): <strong>1,294 participants, 40% women, 390 travel grants, 297 posters, 19 papers, 18 startups</strong> showcased. DLI 2026 announced for Nigeria. The IndabaX regional spin-offs ran in roughly 47 African countries in 2024.</p>
      <p style="color: #888; font-size: 0.9em;"><a href="https://deeplearningindaba.com/2025/" target="_blank" rel="noopener">deeplearningindaba.com/2025</a></p>
    </div>
    <div class="card">
      <h3>AIMS &amp; AMMI</h3>
    ...
    <div class="card">
      ...
      <p><strong>ARIN</strong> (Africa Research and Impact Network): 200+ researchers, focal points in 36 African countries, broad sustainability remit with an AI workstream operationalised through the 2025 AI for Climate Resilience Fellowship. <strong>Lelapa AI</strong>: founded 2022. Co-founders Pelonomi Moiloa (CEO), Jade Abbott (COO), Vukosi Marivate (UP), Benjamin Rosman (Wits RAIL), Pravesh Ranchod (Wits RAIL), and George Konidaris (Brown); the operational arm of the resource-efficient African sovereign-AI position. <strong>Zindi</strong> (Nairobi): 92,000+ registered data practitioners, 460+ challenges run, ~US$1M cumulative prize pool. <strong>Black in AI</strong>: founded 2017 by Timnit Gebru and Rediet Abebe; Africa-specific work largely channelled through Gebru&#39;s DAIR (founded December 2021).</p>
    </div>
    <div class="card">
      <h3>The AI4D Africa lab network</h3>
      <p>The funded research network behind <strong>IDRC AI4D Africa</strong> (and now its global phase 2, <em>Responsible AI, Empowering People</em>, with FCDO and continued Sida participation) supports <strong>13 multidisciplinary AI labs, research labs and innovation labs combined, across the continent</strong>, plus a parallel layer of thematic innovation hubs and policy hubs. The labs cover Anglophone and Francophone Africa, span institutions in eleven countries, and include the recently-launched African Hub on AI Safety, Peace and Security (anchored at UCT, co-led with the Global Center on AI Governance) as the network&#39;s policy-and-governance node.</p>
      <p>When 11.4 referred to &ldquo;AI4D-affiliated labs&rdquo;, this is the network it meant. It is one example of Northern public funding (IDRC, Sida, FCDO) flowing into specific named African research infrastructure rather than into individual researchers, and a counterpoint to the brain-drain framing below, since the network is designed to keep talent on the continent inside funded institutional homes.</p>
      <p>For the full current roster of labs, innovation hubs, and policy hubs, see <a href="https://www.ai4d.ai/projects" target="_blank" rel="noopener">ai4d.ai/projects</a>.</p>
      <p style="color: #888; font-size: 0.9em;"><a href="https://ai4d.ai" target="_blank" rel="noopener">ai4d.ai</a> &middot; <a href="https://idrc-crdi.ca/en/initiative/artificial-intelligence-development" target="_blank" rel="noopener">IDRC AI4D page</a></p>
    </div>
  </div>
  ...
  <p style="color: #555; font-size: 1.05em; margin-bottom: 20px; line-height: 1.8;">Five gaps stand out from the policy-and-institutions picture. Some are obvious. Others are easy to miss because they map onto where the existing infrastructure is.</p>
  ...
  <ol class="step-list">
    ...
    <li><strong>The brain-drain data itself.</strong> A standout talent-related research opportunity for an African postgraduate is an actual, rigorous quantitative study of African AI researcher migration. The work has not been done. The general migration figures circulating are insufficient.</li>
  </ol>
  ...
  <ul class="styled-list">
    ...
    <li><strong>The compute story is now the talent story.</strong> Several higher-education-led compute initiatives on the continent (the UCT African Compute Initiative; the Rwanda AI Scaling Hub) are explicit retention levers for African AI talent: the case for them is not only access to GPUs but the institutional argument that the infrastructure the next decade of African AI work will run on should be built and stewarded on the continent.</li>
    ...
    <li><strong>Brain-drain framing is the wrong default.</strong> The pattern is better described as &ldquo;African AI work is distributed across continent and diaspora&rdquo; than as &ldquo;Africa loses its AI talent to the North&rdquo;. If you are an African postgraduate researcher, your collaborative network is plausibly larger and more international than the brain-drain rhetoric implies. Build it accordingly.</li>
    <li><strong>The work matters.</strong> An institutional landscape with this many gaps means that a postgraduate who chooses to work on one of them can plausibly produce a contribution that the field will recognise. Week 12 closes the course by asking what you would actually do with that opportunity.</li>
  </ul>
  ...
  <div class="resource-placeholder">
    ...
    <p><strong>Lacuna Fund.</strong> <a href="https://lacunafund.org/" target="_blank" rel="noopener">lacunafund.org</a>.</p>
    <p><strong>AI4D Africa &amp; <em>Responsible AI, Empowering People</em>.</strong> Programme home: <a href="https://ai4d.ai" target="_blank" rel="noopener">ai4d.ai</a>; complete projects list (13 labs + innovation hubs + policy hubs): <a href="https://www.ai4d.ai/projects" target="_blank" rel="noopener">ai4d.ai/projects</a>; IDRC overview: <a href="https://idrc-crdi.ca/en/initiative/artificial-intelligence-development" target="_blank" rel="noopener">idrc-crdi.ca</a>; partner roster (innovation research networks): <a href="https://idrc-crdi.ca/en/research-in-action/meet-ai4d-africa-partners-leading-innovation-research" target="_blank" rel="noopener">Meet the AI4D Africa partners</a>; multidisciplinary university labs call: <a href="https://ai4d.ai/calls/multidisciplinary-ai4d-labs/" target="_blank" rel="noopener">ai4d.ai/calls</a>.</p>
  ...
  <p style="color: #555; line-height: 1.75; margin-top: 20px; margin-bottom: 15px;"><strong>Coming up in Week 12:</strong> the integrative capstone for the course. We synthesise the futures half (11.1, 11.2) and the African-capacity half (11.4&ndash;11.6) and ask the question that runs under the second half of the course: <em>what is the most useful thing a postgraduate in this room can actually do?</em> The Week-12 page carries the full brief for the 3-hour solo capstone activity.</p>
"""
