...
SL4_BODY = """
  ...
  <div class="card-grid">
    <div class="card">
      ...
      <p>Announced in March 2026 and led from UCT, the African Compute Initiative is the most directly relevant near-term option for postgraduate AI work on the continent &mdash; <strong>the ACI is planned to be operational towards the end of 2026</strong>, and when it is, access will not be open to everyone. The first cohort will focus on <strong>UCT researchers and AI4D-affiliated labs</strong>. The plan is to scale to roughly 100 users in the first year and around 300 users across at least five partner institutions by year three. The initiative is positioned explicitly as African higher-education-dedicated AI compute &mdash; the missing piece in the picture above. Interim Director: A/Prof Jonathan Shock, UCT (the instructor of this course).</p>
  ...
  <div class="highlight-box">
    ...
    <p>As of May 2026, an African postgraduate researcher still primarily depends on US free-tier cloud for day-to-day AI compute work. Dedicated national and continental compute capacity is announced and partly procured but not yet broadly available. DataSpires is the most concrete individual-user-facing change to this picture, although still in early access; the UCT African Compute Initiative is the most concrete institutional change and is planned to be operational towards the end of 2026. CHPC remains the SA fallback for institutional academic use.</p>
  ...
  <ul class="styled-list">
    ...
    <li><strong>Apply to the UCT ACI once it opens if it fits your work.</strong> The ACI is planned to be operational towards the end of 2026, and the first cohort is being scoped around UCT researchers and AI4D labs. Postgraduates in this course at UCT are part of the audience the initiative is being designed for; the application process is being set up during 2026.</li>
