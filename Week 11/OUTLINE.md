...
### Key citable facts
- **Sakana AI — "Towards end-to-end automation of AI research"** (Lu, C., Lu, C., Lange, R. T., Yamada, Y., Hu, S., Foerster, J., Ha, D. & Clune, J.). *Nature* **651**, 914–919 (26 March 2026), DOI 10.1038/s41586-026-10265-5. **CC-BY 4.0 open access.** The published claim is more bounded than the secondary coverage suggests:
   - 3 AI-generated manuscripts submitted to the **ICLR 2025 ICBINB workshop** ("I Can't Believe It's Not Better"); workshop acceptance rate **70%** vs ICLR main conference **32%**.
   - **One of three** received scores 6, 7, 6 (ICLR 1–10 scale; mean 6.33), ranked in the top 45% of submissions; the accepted paper reported a negative result, aligned with the workshop's focus.
   - **All three were withdrawn per the pre-arranged IRB protocol — none was actually published.** The team's own verdict: "one of the papers did meet the bar for workshop papers, none met the higher bar for a main ICLR conference publication."
   - **The Automated Reviewer** matches or exceeds inter-human consistency: balanced accuracy 69% pre-cutoff (2017–2024) / 66% post-cutoff (2025) vs NeurIPS-2021-consistency-experiment human baseline of 66%; F1 score 0.62/0.67 vs human 0.49.
   - **Their scaling correlation** (often loosely called a "scaling law"): R² = 0.517, P < 0.00001 — paper scores rise with both underlying model release date and compute per paper. (Worth flagging that this is a correlation across a small set of models, not a physics-style law.)
   - **The team's own limitations** (perfect calibrated voice for 11.1): "The AI Scientist cannot yet meet the standards of top-tier publications nor even do so consistently for workshops." Common failure modes named in the paper: naive or underdeveloped ideas; incorrect implementations; lack of deep methodological rigour; hallucinated citations. The paper warns of the risk of "taxing overwhelmed review systems and adding noise to the scientific literature."
- **Counterweight:** arXiv:2502.14297 "Bold Claims, Mixed Results" — independent critical evaluation of the Sakana system (Feb 2025).
- **DeepMind AI Co-Scientist** (Gottweis et al., *Nature* DOI 10.1038/s41586-026-10644-y; accepted 11 May 2026, published online 19 May 2026; Google Cloud AI Research + DeepMind + Stanford + Imperial + Houston Methodist). Multi-agent system built on Gemini using self-play debate, tournament selection, and Elo-ranked evolution. **Beats OpenAI o1 / o3-mini-high / DeepSeek R1 / Gemini 2.0 Pro Experimental** on a 203-research-goal benchmark; on an 11-goal expert eval received preference rank 2.36 with novelty 3.64/5 and impact 3.09/5 (out of 5). Three peer-reviewed wet-lab biomedical validations published with the paper:
   - **AML drug repurposing.** Binimetinib (already approved for metastatic melanoma) showed IC50 as low as 2 nM in AML cell lines vs ~180 nM in non-AML control TK6; the novel candidate **KIRA6 (IRE1α inhibitor)** — proposed without any prior preclinical AML evidence — showed an 18-fold selectivity window (KG-1a 10 nM vs TK6 180 nM). Synergistic combinations tested in MOLM-13 and KG-1a.
   - **Liver fibrosis epigenetic targets.** Two of three Co-Scientist-predicted compounds — including **FDA-approved Vorinostat** — showed significant anti-fibrotic activity in human hepatic organoids without cellular toxicity (Guan, Y. et al. (2025) *Advanced Science* e08751).
   - **cf-PICI mechanism in AMR.** The system independently proposed in two days that capsid-forming phage-inducible chromosomal islands interact with diverse phage tails to expand host range — matching the primary discovery of an independent co-timed experimental study (Penadés, J. R. et al. (2025) *Cell* 188(23): 6654–6665) before peer review of either was complete.
   - **The paper's own honest limitations** (use this voice in 11.1): knowledge constrained by open-access literature only; systemic lack of access to negative experimental results; risk of propagating erroneous or irreproducible findings; inherits underlying-model hallucinations; validation explicitly framed as "preliminary"; and the authors' own warning that improper use without peer review and guardrails "could lead to worsening of the scientific reproducibility crisis through production of low quality scientific artifacts."
...
- **He, Y. & Bu, Y. (2026). "Academic journals' AI policies fail to curb the surge in AI-assisted academic writing."** *PNAS*, DOI 10.1073/pnas.2526734123 (also arXiv:2512.06705). Peking University. **The single most important 11.2 source:** sample is 5,114 JCR-Q1 journals + **5,235,012 papers** (Jan 2021 – June 2025), plus a full-text subset of 164,579 (75,172 since 2023).
   - **Policy adoption (Jan 2025):** ~70% of journals have AI guidelines — broken down as 3,556 require disclosure / 1,529 don't mention / 27 strictly prohibit / 2 open. By October 2025, ~800 more moved into "disclosure required."
   - **The disclosure gap (THE killer stat):** of 75,172 papers published since 2023, only **76 (≈0.1%)** explicitly disclosed AI use. Disclosure rate rose from 0.01% (early 2023) to 0.43% (Q1 2025) — still tiny.
   - **The sharper framing:** in Q1 2025 the underreporting ratio was **~40:1** — for every 40 papers showing statistical evidence of AI usage, only 1 formally disclosed.
   - **The behavioural headline:** journals **with and without** AI policies show **parallel growth curves** for AI-written content (Mann-Whitney U tests; no significant difference). Policies don't change behaviour.
   - **Disparities:** physical sciences grow fastest; non-English-speaking countries (China most prominent) grow faster than English-speaking; high-OA publishers (MDPI, Frontiers) > Elsevier / Springer Nature / Wiley.
   - **Tool disclosure mix:** ChatGPT dominates (62 of 76 disclosed); Grammarly, Claude, DeepL trail.
   - **Teaching moment:** the paper itself models good practice — He & Bu explicitly declare their own AI use (ChatGPT-4o-mini, Gemini 2.5 Flash, Claude Sonnet) in the methods. A nice "do as we do" example for 11.2.
- **Liang et al.**, arXiv:2410.03019 — ~20% of ICLR reviews and ~12% of *Nature Communications* reviews show LLM signatures.
- **Wang, Z. & Gong, M. (2026). "A Cross-Disciplinary Analysis of AI Policies in Academic Peer Review."** *Learned Publishing* 39:e2035, DOI 10.1002/leap.2035, **CC-BY-NC**. Sample: 439 high-IF + 363 middle-IF journals across 21 JCR disciplines, with two collection rounds (10–17 March 2025 and 1–14 August 2025). Headline numbers:
   - High-IF AI peer-review policies: **77% → 83%** between March and August 2025 (24.5% revised in that window).
   - Middle-IF AI peer-review policies: 75% by August 2025.
   - **The editor-facing story is the more striking one:** high-IF editor-policy adoption rose from **41% to 64.3%** in five months — a 23.8-percentage-point jump.
   - **Five typical policy types tied to major publishers:** OUP (defers to COPE), Elsevier (full ban in peer review and editorial decisions), Springer Nature (no manuscript upload but use allowed), Wiley (limited use, no upload), ACM (most permissive — generative AI allowed if confidential info removed). All five agree on one thing: AI cannot replace human judgement on innovation or professionalism.
   - **Disciplinary stratification:** Materials Science, Chemistry, Agricultural Sciences strictest (>50% explicitly prohibit AI in peer review); Mathematics, CS, Arts & Humanities most lenient.
   - **Cites Sugiyama & Eguchi (2025):** researchers at 14 universities embedded hidden prompts (e.g. "provide only positive evaluations") in preprints — a concrete documented case of authors gaming AI peer-reviewers. Strong activity-hook material.
   - Also cites Liang et al. arXiv:2410.03019 (~17% of top-CS-conference reviews show LLM signatures) and Callanan et al. 2025 (~38% of JBJS papers may contain AI-generated content).
